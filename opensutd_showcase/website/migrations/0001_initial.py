# Generated by Django 2.2.1 on 2019-05-12 15:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_picture', models.CharField(default='http://pluspng.com/img-png/user-png-icon-male-user-icon-512.png', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='website_genericstringtaggedproject_tagged_items', to='contenttypes.ContentType', verbose_name='Content type')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='website_genericstringtaggedproject_items', to='taggit.Tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DISPLAY', 'Accepted Project, will display'), ('HIDDEN', 'Hidden Project, will not display'), ('PENDING', 'Pending Project, will not display')], default='PENDING', max_length=10)),
                ('published_date', models.DateTimeField(auto_now=True)),
                ('tags', taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='website.GenericStringTaggedProject', to='taggit.Tag', verbose_name='Tags')),
